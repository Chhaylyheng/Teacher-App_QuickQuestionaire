//
//  BarChartFourViewController.swift
//  C Learning Teacher
//
...
class BarChartFourViewController: UIViewController {
    ...
    private func setBarChart() -> PNBarChart {
        ...
        barChart.xLabels = ["1", "2", "3", "4"]
        barChart.yValues = [CGFloat(ConePer), CGFloat(CtwoPer), CGFloat(CthreePer), CGFloat(CfourPer)]
                ...
                if let dictionary = response.result.value as? [String: Any] {
                    ...
                    for i in 1...self.numArray.count - 1 {
                        ...
                        case 4 :
                            ...
                            self.CfourPer = self.perArray[4] as! Int
                            break
                    ...
                    if self.Cone != 0 || self.Ctwo != 0 || self.Cthree != 0 || self.Cfour != 0 {
